import ChoroplethMap from './choroplethorigin';
...
function MapExplorer({
  ...
  var jsontocsv_array=[];
  jsontocsv_array.push({display:"State or District",count:"Count of Trips Origin"});
  ...
  return (
    ...
    >
      ...
      {/* <h1>Trip Details</h1> */}
        <h2>{currentMap.name} Map (Trip Origin)  
