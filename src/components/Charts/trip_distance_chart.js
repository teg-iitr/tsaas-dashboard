...
import options from './trip_distance_options';
      ...
      for(var k=0;k<survey[i].families[j].members.length;k++)
      {
        for(var l=0;l<survey[i].families[j].members[k].trips.length;l++)
        {
            for(var m=0;m<survey[i].families[j].members[k].trips[l].origin_destination.length;m++)
            {
              ...
              //   }
              if(options.hasOwnProperty(survey[i].families[j].members[k].trips[l].origin_destination[m].travelDistance))
              options[survey[i].families[j].members[k].trips[l].origin_destination[m].travelDistance].count++;
              else
              nulls++;
            }
        }
...
function download_png() {
  ...
  return (
        ...
        <div id='trip_distance' className="charts-header">
          { chart_type===0  &&
