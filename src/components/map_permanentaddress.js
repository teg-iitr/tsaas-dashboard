import ChoroplethMap from './choroplethpermanentaddress';
...
function MapExplorer({
  ...
  var jsontocsv_array=[];
  jsontocsv_array.push({display:"State or District",count:"Number of Residents"});
  ...
  const setHoveredRegion = useCallback(
    ...
    // console.log(currentHoveredRegion.name);
