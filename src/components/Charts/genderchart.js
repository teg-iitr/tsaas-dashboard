...
import options from './gender_options';
  ...
  var survey = props.data;
    ...
    continue;
      for(var j=0;j<survey[i].families.length;j++)
      {
        ...
        {
          // if(!gender.hasOwnProperty(survey[i].families[j].members[k].gender))
          // gender[survey[i].families[j].members[k].gender]=0;
          // gender[survey[i].families[j].members[k].gender]++;
          if(options.hasOwnProperty(survey[i].families[j].members[k].gender))
          options[survey[i].families[j].members[k].gender].count++;
          else
          nulls++;
        }
      }
...
function download_png() {
  ...
  return (
        ...
        <div id='gender_ratio' className="charts-header">
           { chart_type===0  &&
